# 🏟️ D-Sport Center - Hệ Thống Quản Lý & Đặt Lịch Sân Thể Thao Trực Tuyến
...
*   **Migration & Quản Lý Schema:** Liquibase Core giúp kiểm soát phiên bản database chuyên nghiệp.
...
3. Khởi chạy ứng dụng:
   ...
   ```
   *Lưu ý: Liquibase sẽ tự động chạy và khởi tạo toàn bộ cấu trúc bảng cơ sở dữ liệu.*
